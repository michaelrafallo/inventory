...
|
<a href="{{ URL::route($view.'.index', ['preview' => 1, query_vars()]) }}" class="btn-preview">Generate PO Report</a>
@endif

@if( App\Permission::has_access('purchase-orders', ['report']) )
|
<a href="{{ URL::route($view.'.payables') }}" class="btn-preview">Generate Payables Report</a>
@endif
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">  
                                    ...
                                    <div class="col-md-6">         
                                    <h5>Supplier</h5>                           
                                        {{ Form::select('supplier', ['' => 'All Suppliers'] + $post->select_posts(['post_type' => 'supplier']),  
                                        Input::get('supplier'), ['class' => 'select2 form-control']) }}
                                    </div>
                                    ...
                                    <div class="col-md-6">         
                                    <h5>Order Status</h5>                           
                                        {{ Form::select('fulfilled', ['' => 'All Order Status'] + po_status(), Input::get('fulfilled'), ['class' => 'select2 form-control']) }}                                        
                                    </div>

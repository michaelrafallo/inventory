                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                   {{ Form::select('supplier', ['' => 'Select Supplier'] + $post->select_posts(['post_type' => 'supplier']), Input::old('supplier', $supplier), ['class' => 'form-control select2 supplier']) }}
                                    <!-- START error message -->
                                    {!! $errors->first('supplier','<span class="help-block"><p class="text-danger">:message</p></span>') !!}
                                    <!-- END error message -->
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="text" name="po_no" class="form-control" value="{{ Input::old('po_no') }}">
                        ...
                        <div class="col-md-6 border-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                   <textarea name="delivery_address" class="form-control" rows="3" placeholder="Delivery Address">{{ Input::old('delivery_address', $delivery_address) }}</textarea>
                                </div>
                            </div>  

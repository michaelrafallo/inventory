...
<title>Sales Order Register Report</title>
...
<table width="100%">
    <tr>
        ...
        <td align="right" valign="top">
            <b>Sales Order Register Report</b><br>
    ...
    <table width="100%" cellpadding="3" cellspacing="0" border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $post->find($postmeta->customer)->post_title }}</td>
                ...
                <td>{{ status_ico($postmeta->delivered) }}, {{ status_ico($row->post_status) }}</td>
            </tr>
            <?php 

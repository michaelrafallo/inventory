        ...
        <form action="" class="form-horizontal form-submit" method="post">
            <div class="portlet light bordered">
                <div class="portlet-body">
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="no-margin uppercase">{{ $post->find($info->customer)->post_title }}</h3>
                                <h5>{{ $info->address }}</h5>
                            </div>
                            <div class="col-md-6 text-right">
                                <h5 class="uppercase">Reference No. <b>{{ $info->reference_no }}</b></h5>   
                                {{ status_ico($info->delivered) }} {{ status_ico($info->post_status) }}
                        ...
                        <div class="row margin-top-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        {{ Form::select('customer', $post->select_posts(['post_type' => 'customer']), Input::old('customer', $info->customer), ['class' => 'form-control customer select2']) }}
                                        <!-- START error message -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="si_no" class="form-control" value="{{ Input::old('si_no', $info->si_no) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="dr_no" class="form-control" value="{{ Input::old('dr_no', $info->dr_no) }}">
                                        <span class="help-inline">Overwrite Reference No.</span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 border-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <div class="mt-checkbox-inline">
                                            ...
                                            <input type="checkbox" name="delivered" value="delivered" {{ checked($info->delivered, 'delivered') }}> Delivered
                                            <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                            @if($info->balance == 0)
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Show on report</label>
                                    <div class="col-md-7">
                                        <div class="mt-checkbox-inline">
                                            <label class="mt-checkbox">
                                            <input type="checkbox" name="show_price" value="1" {{ checked($info->show_price, '1') }}> Price
                                            <span></span>
                                            </label>

                                            <label class="mt-checkbox">
                                            <input type="checkbox" name="show_total" value="1" {{ checked($info->show_total, '1') }}> Total
                                            <span></span>
                                            </label>
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    ...
                    @include($view.'.temp.delivered-orders')
                    @endif

                    <div class="{{ $info->delivered == 'delivered' ? 'hide' : '' }}">
                    @include($view.'.temp.undelivered-orders')
                    </div>
...
<div class="form-actions-fixed">
    <div class="col-md-4 col-xs-6">
        ...
        <a href="{{ URL::route($view.'.edit', [$info->id, 'preview' => 1]) }}" class="btn-preview btn btn-outline green btn-xs uppercase"><i class="fa fa-print"></i> Delivery Receipt</a>

        <a href="{{ URL::route('app.customers.soa', [$info->customer, 'soid' => $info->id, 'post_status' => $info->post_status]) }}" class="btn-xs btn btn-outline green btn-preview"><i class="fa fa-print"></i> Invoice</a>

...
@if( App\Permission::has_access('sales-orders', ['report']) )
|
<a href="{{ URL::route($view.'.index', ['preview' => 1, query_vars()]) }}" class="btn-preview">Generate SO Report</a>
|
<a href="{{ URL::route($view.'.sales') }}" class="btn-preview">Generate Sales Report</a>
@endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group input-group-sm input-large daterange-picker input-daterange">
                                <input type="text" class="form-control period" name="from" value="{{ Input::get('from', $from) }}">
                                <span class="input-group-addon"> to </span>
                                <input type="text" class="form-control period" name="to" value="{{ Input::get('to', $to) }}"> 
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="input-group input-group-sm">
                                <input class="form-control" type="text" name="post_content" placeholder="Reference No." value="{{ Input::get('post_content') }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">  
                                    <div class="col-md-6">         
                                    <h5>Customer</h5>                           
                                        {{ Form::select('customer', ['' => 'All Customers'] + $post->select_posts(['post_type' => 'customer']),  
                                        Input::get('customer'), ['class' => 'select2 form-control']) }}
                                    </div>

                                    <div class="col-md-6">         
                                    <h5>Payment Status</h5>                           
                                        {{ Form::select('post_status', ['' => 'All Payment Status'] + payment_status(), Input::get('post_status'), ['class' => 'select2 form-control']) }}
                                    </div>

                                    <div class="col-md-6">         
                                    <h5>Order Status</h5>                           
                                        {{ Form::select('delivered', ['' => 'All Order Status'] + so_status(), Input::get('delivered'), ['class' => 'select2 form-control']) }}                                        
                                    </div>
                                ...
                                <div class="form-group">  
                                    <div class="col-md-12">         
                                    <h5>Company</h5>                           
                                        {{ Form::select('company', ['' => 'Choose Header'] + $post->select_posts(['post_type' => 'company']),  
                                        Input::get('company', $company), ['class' => 'select2 form-control']) }}

...
@if( App\Permission::has_access('products', ['report']) )
|
<a href="{{ URL::route($view.'.index', ['preview' => 1, query_vars()]) }}" class="btn-preview">Generate Inventory Report</a>
@endif
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-body">
                                ...
                                <label class="mt-checkbox">
                                    <input type="checkbox" name="empty" value="1" {{ checked(Input::get('empty'), '1') }}> Do not include products without transactions on report.
                                    <span></span>
                                </label>

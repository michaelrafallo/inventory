            ...
            <table class="table table-hover table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="text-right" width="150"><a href="{{ URL::route($view.'.terms') }}" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Add New </a></th>
                    </tr>
                </thead>
                <tbody>
                    <?php $order = 0; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="text-right">                    
                                ...
                                <a href="{{ URL::route($view.'.terms', ['pid' => $row->id]) }}" class="btn green btn-xs uppercase">Edit</a>
        ...
        <div class="col-md-3">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <h5>Terms <span class="required">*</span></h5>
                        <input type="text" class="form-control rtip" name="name" placeholder="Terms" value="{{ Input::old('name', @$info->post_title ) }}">
                        <!-- START error message -->
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <h5>Days <span class="required">*</span></h5>
                        <input type="number" class="form-control rtip" name="days" placeholder="Days" value="{{ Input::old('days', @$info->post_name ) }}" min="0">
                        <!-- START error message -->
                        {!! $errors->first('days','<span class="help-block"><span class="text-danger">:message</span></span>') !!}
                        <!-- END error message -->
                    </div>
                </div>

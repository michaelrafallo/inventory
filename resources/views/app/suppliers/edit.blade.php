                ...
                <form action="" class="form-horizontal form-submit" method="post">
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="ver-inline-menu tabbable margin-top-20 navigation-tab">
                            <li class="{{ actived(Input::get('tab'), 1) }}">
                                <a href="?tab=1">
                                    <i class="fa fa-user"></i> Supplier Info</a>
                                <span class="after"> </span>
                            </li>
                            <li class="{{ actived(Input::get('tab'), 2) }}">
                                <a href="?tab=2">
                                    <i class="fa fa-briefcase"></i> Supplier Products</a>
                            </li>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content load-details">
                            @include('app.suppliers.tabs.details')
                        </div>
                    </div>
...
<div class="modal fade form-modal" id="popupModal"  tabindex="1" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" aria-hidden="false">
  <div class="modal-dialog modal-md">
    ...
    <form class="form-horizontal form-modal-submit" method="post" action="{{ URL::route('app.suppliers.product') }}">
        {{ csrf_field() }}
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <h5 class="col-md-12 sbold">Supplier Product</h5>
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <h5>Supplier Price <span class="text-danger">*</span></h5>
                    <input type="text" class="form-control text-right rtip" name="supplier_price" placeholder="0.00">   
                    <span id="supplier_price" class="msg-error"></span>               
                </div>
...
$(document).on('click','.btn-add', function(e) {
    e.preventDefault();
    $('.msg-error').html('');
    modal.find("input[type=text], textarea, input[name=pid]").val('');
    modal.modal('show');
